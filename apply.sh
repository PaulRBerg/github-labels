...
# Sablier
github-label-sync --access-token $GITHUB_TOKEN --allow-added-labels --labels ./labels.yml sablierhq/docs
github-label-sync --access-token $GITHUB_TOKEN --allow-added-labels --labels ./labels.yml sablierhq/safe-app
github-label-sync --access-token $GITHUB_TOKEN --allow-added-labels --labels ./labels.yml sablierhq/subgraph
github-label-sync --access-token $GITHUB_TOKEN --allow-added-labels --labels ./labels.yml sablierhq/v1-interfaces
github-label-sync --access-token $GITHUB_TOKEN --allow-added-labels --labels ./labels.yml sablierhq/v2-core
github-label-sync --access-token $GITHUB_TOKEN --allow-added-labels --labels ./labels.yml sablierhq/v2-interfaces
github-label-sync --access-token $GITHUB_TOKEN --allow-added-labels --labels ./labels.yml sablierhq/v2-periphery